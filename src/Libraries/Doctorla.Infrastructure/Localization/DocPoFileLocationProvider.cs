...
/// </summary>
public class DocPoFileLocationProvider : ILocalizationFileLocationProvider
{
    private readonly IFileProvider fileProvider = null;
    private readonly string resourcesContainer = null;

    public DocPoFileLocationProvider(IHostEnvironment hostingEnvironment, IOptions<LocalizationOptions> localizationOptions)
    {
