...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(DocAction.View, DocResource.Roles)]
    ...
    [MustHavePermission(DocAction.View, DocResource.RoleClaims)]
    ...
    [MustHavePermission(DocAction.Update, DocResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(DocAction.Create, DocResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(DocAction.Delete, DocResource.Roles)]
