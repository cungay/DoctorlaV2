...
namespace Doctorla.Host.Controllers.Identity;
...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(DocAction.View, DocResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(DocAction.View, DocResource.UserRoles)]
    ...
    [MustHavePermission(DocAction.Update, DocResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(DocAction.Create, DocResource.Users)]
    ...
    [MustHavePermission(DocAction.Update, DocResource.Users)]
    [ApiConventionMethod(typeof(DocApiConventions), nameof(DocApiConventions.Register))]
    ...
    [ApiConventionMethod(typeof(DocApiConventions), nameof(DocApiConventions.Search))]
